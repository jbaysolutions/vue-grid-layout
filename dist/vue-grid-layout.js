...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GridLayout = __webpack_require__(55);
	
	var _GridLayout2 = _interopRequireDefault(_GridLayout);
	
	var _ResponsiveGridLayout = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _draggableUtils = __webpack_require__(51);
	...
	var VueDragDrop = __webpack_require__(52);
	...
	exports.default = {
	    ...
	    events: {
	        ...
	        compact: function compact(layout) {
	            var l = (0, _utils.getLayoutItem)(layout, this.id);
	            this.x = l.x;
	            this.y = l.y;
	            this.h = l.h;
	            this.w = l.w;
	  ...
	  for (var _i8 = 0, len = children.length; _i8 < len; _i8++) {
	    ...
	    if (exists) {
	      ...
	      if (g) {
	        ...
	        if (verticalCompact) {
	          newItem = cloneLayoutItem((0, _extends3.default)({}, g, { y: Math.min(bottom(layout), g.y), i: child.key }));
	        } else {
	          newItem = cloneLayoutItem((0, _extends3.default)({}, g, { y: g.y, i: child.key }));
	        }
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    ready: function ready() {
	        ...
	        this.layout = (0, _utils.compact)(this.layout, this.verticalCompact);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _responsiveUtils = __webpack_require__(64);
	...
	exports.default = {
	    ...
	    ready: function ready() {
	        ...
	        if (this.width === null) {
	            ...
	            this.colNum = (0, _responsiveUtils.getColsFromBreakpoint)(this.breakpoint, this.cols);
	            // Get the initial layout. This can tricky; we try to generate one however possible if one doesn't exist
	            // for this layout.
	            this.layout = (0, _responsiveUtils.findOrGenerateResponsiveLayout)(this.layouts, this.breakpoints, this.breakpoint, this.breakpoint, this.colNum, this.verticalCompact);
	            this.lastBreakpoint = this.breakpoint;
