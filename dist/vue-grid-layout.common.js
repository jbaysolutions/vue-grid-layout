...
/*: Layout*/
{
  ...
  if (layouts[breakpoint]) return Object(utils["b" /* cloneLayout */])(layouts[breakpoint]); // Find or generate the next layout
  ...
  layout = Object(utils["b" /* cloneLayout */])(layout || []); // clone layout so we don't modify existing items

  return Object(utils["c" /* compact */])(Object(utils["d" /* correctBounds */])(layout, {
    cols: cols
  }), verticalCompact);
}
...
/* harmony default export */ var GridLayoutvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    containerHeight: function containerHeight() {
      ...
      return Object(utils["a" /* bottom */])(this.layout) * (this.rowHeight + this.margin[1]) + this.margin[1] + 'px';
    },
