...
import { cloneLayout, compact, correctBounds } from "./new_utils";

import type { CompactType, Layout } from "./new_utils";
...
export function getColsFromBreakpoint(
    ...
    if (!cols[breakpoint]) {
        throw new Error(
            "ResponsiveVueGridLayout: `cols` entry for breakpoint " +
            breakpoint +
            " is missing!"
        );
    }
